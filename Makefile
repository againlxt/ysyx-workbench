...
perf:
	$(MAKE) -C $(NPC_HOME)/chisel/cpu yosys
	$(MAKE) -C $(YSYX_HOME)/yosys-sta sta
	$(MAKE) -C $(YSYX_HOME)/am-kernels/benchmarks/microbench ARCH=riscv32e-ysyxsoc run mainargs=train
