...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [31:0] getCmd_cmd; // @[src/main/scala/lsu/LSU.scala 233:57]
  wire [31:0] mTrace_data; // @[src/main/scala/lsu/LSU.scala 237:57]
  wire [31:0] mTrace_addr; // @[src/main/scala/lsu/LSU.scala 237:57]
  wire [1:0] mTrace_memop; // @[src/main/scala/lsu/LSU.scala 237:57]
  wire  mTrace_wOrR; // @[src/main/scala/lsu/LSU.scala 237:57]
  wire  mTrace_enable; // @[src/main/scala/lsu/LSU.scala 237:57]
  ...
  wire  _rdataShiftWire_T_101 = io_exu2LSU_bits_aluData <= 32'hf001fff & io_exu2LSU_bits_aluData >= 32'hf00000; // @[src/main/scala/lsu/LSU.scala 139:57]
  wire  _rdataShiftWire_T_104 = io_exu2LSU_bits_aluData <= 32'hf001fff & io_exu2LSU_bits_aluData >= 32'hf00000 &
    _io_lsu2Mem_wdata_T_1; // @[src/main/scala/lsu/LSU.scala 139:90]
  wire  _rdataShiftWire_T_107 = io_exu2LSU_bits_aluData <= 32'hf001fff & io_exu2LSU_bits_aluData >= 32'hf00000 &
    _io_lsu2Mem_wdata_T_1 & _wMaskWire_T_5; // @[src/main/scala/lsu/LSU.scala 139:118]
  wire  _rdataShiftWire_T_116 = _rdataShiftWire_T_104 & _wMaskWire_T_1; // @[src/main/scala/lsu/LSU.scala 140:118]
  wire  _rdataShiftWire_T_127 = _rdataShiftWire_T_104 & _wMaskWire_T_3; // @[src/main/scala/lsu/LSU.scala 141:118]
  wire  _rdataShiftWire_T_135 = _rdataShiftWire_T_101 & _io_lsu2Mem_wdata_T_20; // @[src/main/scala/lsu/LSU.scala 142:90]
  wire  _rdataShiftWire_T_143 = _rdataShiftWire_T_101 & _io_lsu2Mem_wdata_T_25; // @[src/main/scala/lsu/LSU.scala 143:90]
  wire  _rdataShiftWire_T_146 = _rdataShiftWire_T_101 & _io_lsu2Mem_wdata_T_25 & _wMaskWire_T_1; // @[src/main/scala/lsu/LSU.scala 143:118]
  wire  _rdataShiftWire_T_157 = _rdataShiftWire_T_143 & _wMaskWire_T_3; // @[src/main/scala/lsu/LSU.scala 144:118]
  wire  _rdataShiftWire_T_165 = _rdataShiftWire_T_101 & _io_lsu2Mem_wdata_T_40; // @[src/main/scala/lsu/LSU.scala 145:90]
  ...
  wire [31:0] _signDataWire_T = _rdataShiftWire_T_5 ? _rdataShiftWire_T_7 : _rdataShiftWire_T_186; // @[src/main/scala/lsu/LSU.scala 147:91]
  ...
  reg  readyReg; // @[src/main/scala/lsu/LSU.scala 246:31]
  wire  _readyReg_T_4 = io_exu2LSU_valid & io_exu2LSU_ready ? io_lsu2WBU_valid : 1'h1; // @[src/main/scala/lsu/LSU.scala 251:40]
  wire  _GEN_26 = readyReg ? _readyReg_T_4 : readyReg; // @[src/main/scala/lsu/LSU.scala 248:26 246:31 251:34]
  wire  _GEN_27 = ~readyReg ? io_lsu2WBU_valid : _GEN_26; // @[src/main/scala/lsu/LSU.scala 248:26 249:36]
  wire  _io_lsu2WBU_valid_T_3 = handReg & ~io_exu2LSU_bits_memValid; // @[src/main/scala/lsu/LSU.scala 258:18]
  wire [4:0] _io_rd_T_4 = io_exu2LSU_ready & ~io_lsu2WBU_valid ? 5'h0 : io_exu2LSU_bits_inst[11:7]; // @[src/main/scala/lsu/LSU.scala 273:45]
  wire [4:0] _io_rd_T_5 = io_exu2LSU_bits_regWR ? _io_rd_T_4 : 5'h0; // @[src/main/scala/lsu/LSU.scala 273:23]
  ...
  GetCommond getCmd ( // @[src/main/scala/lsu/LSU.scala 233:57]
    .cmd(getCmd_cmd)
  );
  MTrace mTrace ( // @[src/main/scala/lsu/LSU.scala 237:57]
    .data(mTrace_data),
    .addr(mTrace_addr),
    .memop(mTrace_memop),
    .wOrR(mTrace_wOrR),
  ...
  assign io_exu2LSU_ready = readyReg; // @[src/main/scala/lsu/LSU.scala 256:33]
  ...
  assign io_lsu2WBU_valid = state == 2'h3 | _io_lsu2WBU_valid_T_3; // @[src/main/scala/lsu/LSU.scala 257:61]
  assign io_lsu2WBU_bits_pc = io_exu2LSU_bits_pc; // @[src/main/scala/lsu/LSU.scala 260:33]
  assign io_lsu2WBU_bits_memData = sOrUWire ? _memRdDataWire_T_1 : rdataShiftWire; // @[src/main/scala/lsu/LSU.scala 164:38]
  assign io_lsu2WBU_bits_aluData = io_exu2LSU_bits_aluData; // @[src/main/scala/lsu/LSU.scala 262:33]
  assign io_lsu2WBU_bits_csrWData = io_exu2LSU_bits_csrWData; // @[src/main/scala/lsu/LSU.scala 263:33]
  assign io_lsu2WBU_bits_csrData = io_exu2LSU_bits_csrData; // @[src/main/scala/lsu/LSU.scala 264:33]
  assign io_lsu2WBU_bits_inst = io_exu2LSU_bits_inst; // @[src/main/scala/lsu/LSU.scala 266:33]
  assign io_lsu2WBU_bits_regWR = io_exu2LSU_bits_regWR; // @[src/main/scala/lsu/LSU.scala 267:33]
  assign io_lsu2WBU_bits_toReg = io_exu2LSU_bits_toReg; // @[src/main/scala/lsu/LSU.scala 268:33]
  assign io_lsu2WBU_bits_ecall = io_exu2LSU_bits_ecall; // @[src/main/scala/lsu/LSU.scala 269:33]
  assign io_lsu2WBU_bits_csrEn = io_exu2LSU_bits_csrEn; // @[src/main/scala/lsu/LSU.scala 270:33]
  assign io_lsu2WBU_bits_csrWr = io_exu2LSU_bits_csrWr; // @[src/main/scala/lsu/LSU.scala 271:33]
  assign io_lsu2WBU_bits_fencei = io_exu2LSU_bits_memOP == 3'h7; // @[src/main/scala/lsu/LSU.scala 272:47]
  assign io_rd = _io_rd_T_5[3:0]; // @[src/main/scala/lsu/LSU.scala 273:17]
  assign io_bypassValid = ~(io_exu2LSU_bits_toReg == 2'h1 & (_T_13 | nextState == 2'h2)); // @[src/main/scala/lsu/LSU.scala 274:52]
  ...
  assign getCmd_cmd = io_exu2LSU_bits_inst; // @[src/main/scala/lsu/LSU.scala 234:41]
  assign mTrace_data = io_exu2LSU_bits_memWR ? io_lsu2Mem_wdata : memRdDataWire; // @[src/main/scala/lsu/LSU.scala 238:47]
  assign mTrace_addr = io_exu2LSU_bits_aluData; // @[src/main/scala/lsu/LSU.scala 239:41]
  assign mTrace_memop = io_exu2LSU_bits_memOP[1:0]; // @[src/main/scala/lsu/LSU.scala 240:53]
  assign mTrace_wOrR = io_exu2LSU_bits_memWR; // @[src/main/scala/lsu/LSU.scala 241:54]
  ...
  always @(posedge clock) begin
    ...
    readyReg <= reset | _GEN_27; // @[src/main/scala/lsu/LSU.scala 246:{31,31}]
  end
