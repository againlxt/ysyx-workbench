...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  EFCC_valid; // @[src/main/scala/exu/EXU.scala 111:57]
  wire [31:0] EFCC_counterType; // @[src/main/scala/exu/EXU.scala 111:57]
  wire [31:0] EFCC_data; // @[src/main/scala/exu/EXU.scala 111:57]
  ...
  reg [31:0] exuFinCalCnt; // @[src/main/scala/exu/EXU.scala 105:43]
  wire  _T = io_idu2EXU_valid & io_idu2EXU_ready; // @[src/main/scala/exu/EXU.scala 106:40]
  wire [31:0] _exuFinCalCnt_T_1 = exuFinCalCnt + 32'h1; // @[src/main/scala/exu/EXU.scala 109:54]
  wire [4:0] _io_rd_T_4 = io_idu2EXU_ready & ~io_exu2LSU_valid ? 5'h0 : io_idu2EXU_bits_inst[11:7]; // @[src/main/scala/exu/EXU.scala 143:45]
  wire [4:0] _io_rd_T_5 = io_idu2EXU_bits_regWR ? _io_rd_T_4 : 5'h0; // @[src/main/scala/exu/EXU.scala 143:23]
  reg  validReg; // @[src/main/scala/exu/EXU.scala 145:31]
  reg  readyReg; // @[src/main/scala/exu/EXU.scala 146:31]
  wire  _T_1 = ~io_flush; // @[src/main/scala/exu/EXU.scala 147:14]
  wire  _validReg_T_1 = io_exu2LSU_valid & io_exu2LSU_ready; // @[src/main/scala/exu/EXU.scala 151:66]
  wire  _validReg_T_4 = io_exu2LSU_valid & io_exu2LSU_ready ? _T : 1'h1; // @[src/main/scala/exu/EXU.scala 151:48]
  wire  _GEN_1 = validReg ? _validReg_T_4 : validReg; // @[src/main/scala/exu/EXU.scala 145:31 148:34 151:42]
  wire  _GEN_2 = ~validReg ? _T : _GEN_1; // @[src/main/scala/exu/EXU.scala 148:34 149:44]
  wire  _readyReg_T_4 = _T ? _validReg_T_1 : 1'h1; // @[src/main/scala/exu/EXU.scala 158:48]
  wire  _GEN_3 = readyReg ? _readyReg_T_4 : readyReg; // @[src/main/scala/exu/EXU.scala 146:31 155:34 158:42]
  wire  _GEN_4 = ~readyReg ? _validReg_T_1 : _GEN_3; // @[src/main/scala/exu/EXU.scala 155:34 156:44]
  wire  _GEN_5 = ~io_flush & _GEN_2; // @[src/main/scala/exu/EXU.scala 147:26 163:26]
  wire  _GEN_6 = ~io_flush ? _GEN_4 : 1'h1; // @[src/main/scala/exu/EXU.scala 147:26 164:26]
  ...
  PerformanceCounter EFCC ( // @[src/main/scala/exu/EXU.scala 111:57]
    .valid(EFCC_valid),
    .counterType(EFCC_counterType),
    .data(EFCC_data)
  );
  assign io_idu2EXU_ready = readyReg & _T_1; // @[src/main/scala/exu/EXU.scala 166:45]
  assign io_exu2LSU_valid = validReg & _T_1; // @[src/main/scala/exu/EXU.scala 167:37]
  assign io_exu2LSU_bits_pc = io_idu2EXU_bits_pc; // @[src/main/scala/exu/EXU.scala 117:49]
  assign io_exu2LSU_bits_memData = io_idu2EXU_bits_rs2Data; // @[src/main/scala/exu/EXU.scala 118:41]
  ...
  assign io_exu2LSU_bits_immData = io_idu2EXU_bits_imm; // @[src/main/scala/exu/EXU.scala 122:41]
  assign io_exu2LSU_bits_rs1Data = io_idu2EXU_bits_rs1Data; // @[src/main/scala/exu/EXU.scala 123:41]
  assign io_exu2LSU_bits_inst = io_idu2EXU_bits_inst; // @[src/main/scala/exu/EXU.scala 124:41]
  assign io_exu2LSU_bits_regWR = io_idu2EXU_bits_regWR; // @[src/main/scala/exu/EXU.scala 126:41]
  assign io_exu2LSU_bits_memWR = io_idu2EXU_bits_memWR; // @[src/main/scala/exu/EXU.scala 127:41]
  assign io_exu2LSU_bits_memValid = io_idu2EXU_bits_memValid; // @[src/main/scala/exu/EXU.scala 128:41]
  assign io_exu2LSU_bits_memOP = io_idu2EXU_bits_memOP; // @[src/main/scala/exu/EXU.scala 129:41]
  assign io_exu2LSU_bits_toReg = io_idu2EXU_bits_toReg; // @[src/main/scala/exu/EXU.scala 130:41]
  assign io_exu2LSU_bits_ecall = io_idu2EXU_bits_ecall; // @[src/main/scala/exu/EXU.scala 131:41]
  assign io_exu2LSU_bits_csrEn = io_idu2EXU_bits_csrEn; // @[src/main/scala/exu/EXU.scala 132:41]
  assign io_exu2LSU_bits_csrWr = io_idu2EXU_bits_csrWr; // @[src/main/scala/exu/EXU.scala 133:41]
  assign io_exu2CSR_mret = io_idu2EXU_bits_mret; // @[src/main/scala/exu/EXU.scala 140:49]
  assign io_exu2CSR_ecall = io_idu2EXU_bits_ecall; // @[src/main/scala/exu/EXU.scala 141:49]
  assign io_exu2CSR_csr = io_idu2EXU_bits_inst[31:20]; // @[src/main/scala/exu/EXU.scala 139:60]
  assign io_exu2Branch_branchCtr = io_idu2EXU_bits_branch; // @[src/main/scala/exu/EXU.scala 135:41]
  assign io_exu2Branch_less = alu_io_less; // @[src/main/scala/exu/EXU.scala 136:49]
  assign io_exu2Branch_zero = alu_io_zero; // @[src/main/scala/exu/EXU.scala 137:49]
  assign io_rd = _io_rd_T_5[3:0]; // @[src/main/scala/exu/EXU.scala 143:17]
  ...
  assign EFCC_valid = io_exu2LSU_valid; // @[src/main/scala/exu/EXU.scala 112:41]
  assign EFCC_counterType = 32'h8; // @[src/main/scala/exu/EXU.scala 113:41]
  assign EFCC_data = exuFinCalCnt; // @[src/main/scala/exu/EXU.scala 114:41]
  always @(posedge clock) begin
    if (reset) begin // @[src/main/scala/exu/EXU.scala 105:43]
      exuFinCalCnt <= 32'h0; // @[src/main/scala/exu/EXU.scala 105:43]
    end else if (io_idu2EXU_valid & io_idu2EXU_ready) begin // @[src/main/scala/exu/EXU.scala 106:60]
      exuFinCalCnt <= 32'h1; // @[src/main/scala/exu/EXU.scala 107:38]
    end else begin
      exuFinCalCnt <= _exuFinCalCnt_T_1; // @[src/main/scala/exu/EXU.scala 109:38]
    end
    if (reset) begin // @[src/main/scala/exu/EXU.scala 145:31]
      validReg <= 1'h0; // @[src/main/scala/exu/EXU.scala 145:31]
    end else begin
      validReg <= _GEN_5;
    end
    readyReg <= reset | _GEN_6; // @[src/main/scala/exu/EXU.scala 146:{31,31}]
  end
