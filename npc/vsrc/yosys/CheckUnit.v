module CheckUnit(
  ...
  input  [25:0] io_checkUnitIO_checkUnit2Sram_tagVec_0, // @[src/main/scala/ifu/Icache.scala 328:20]
  ...
  output [25:0] io_checkUnitIO_checkUnit2Sram_tagBuf, // @[src/main/scala/ifu/Icache.scala 328:20]
  output [1:0]  io_checkUnitIO_checkUnit2Sram_replaceIndex, // @[src/main/scala/ifu/Icache.scala 328:20]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [1:0] memIndexWire = io_checkUnitIO_fetchReq2CheckUnit_bits[5:4]; // @[src/main/scala/ifu/Icache.scala 334:81]
  wire [25:0] tagWire = io_checkUnitIO_fetchReq2CheckUnit_bits[31:6]; // @[src/main/scala/ifu/Icache.scala 335:49]
  ...
  reg  cacheValidReg_2_0; // @[src/main/scala/ifu/Icache.scala 339:42]
  reg  cacheValidReg_3_0; // @[src/main/scala/ifu/Icache.scala 339:42]
  wire  _GEN_1 = 2'h1 == memIndexWire ? cacheValidReg_1_0 : cacheValidReg_0_0; // @[src/main/scala/ifu/Icache.scala 343:{96,96}]
  wire  _GEN_2 = 2'h2 == memIndexWire ? cacheValidReg_2_0 : _GEN_1; // @[src/main/scala/ifu/Icache.scala 343:{96,96}]
  wire  _GEN_3 = 2'h3 == memIndexWire ? cacheValidReg_3_0 : _GEN_2; // @[src/main/scala/ifu/Icache.scala 343:{96,96}]
  wire  hitVec_0 = _GEN_3 & io_checkUnitIO_checkUnit2Sram_tagVec_0 == tagWire; // @[src/main/scala/ifu/Icache.scala 343:96]
  ...
  wire [7:0] _GEN_78 = {{5'd0}, _findEndWire_T_4}; // @[src/main/scala/ifu/Icache.scala 351:56]
  wire  _findEndWire_T_5 = busrtCnt == _GEN_78; // @[src/main/scala/ifu/Icache.scala 351:56]
  wire  findEndWire = _findEndWire_T_1 & busrtCnt == _GEN_78; // @[src/main/scala/ifu/Icache.scala 351:44]
  ...
  wire [31:0] _GEN_79 = {{22'd0}, _io_checkUnitIO_checkUnit2Mem_araddr_T_4}; // @[src/main/scala/ifu/Icache.scala 417:79]
  wire [31:0] _io_checkUnitIO_checkUnit2Mem_araddr_T_6 = _io_checkUnitIO_checkUnit2Mem_araddr_T_1 + _GEN_79; // @[src/main/scala/ifu/Icache.scala 417:79]
  ...
  wire  _T_12 = io_checkUnitIO_checkUnit2Mem_arvalid & io_checkUnitIO_checkUnit2Mem_arready; // @[src/main/scala/ifu/Icache.scala 464:76]
  ...
  wire  _GEN_52 = _findEndWire_T & busrtCnt < _GEN_78 | arvalidReg; // @[src/main/scala/ifu/Icache.scala 470:160 385:42 471:52]
  wire  _GEN_53 = _T_12 ? 1'h0 : _GEN_52; // @[src/main/scala/ifu/Icache.scala 468:116 469:52]
  ...
  wire [31:0] _GEN_71 = 2'h1 == offsetWire ? io_checkUnitIO_checkUnit2Sram_cacheLineVec_0_1 :
    io_checkUnitIO_checkUnit2Sram_cacheLineVec_0_0; // @[src/main/scala/ifu/Icache.scala 508:{12,12}]
  wire [31:0] _GEN_72 = 2'h2 == offsetWire ? io_checkUnitIO_checkUnit2Sram_cacheLineVec_0_2 : _GEN_71; // @[src/main/scala/ifu/Icache.scala 508:{12,12}]
  wire [31:0] _GEN_73 = 2'h3 == offsetWire ? io_checkUnitIO_checkUnit2Sram_cacheLineVec_0_3 : _GEN_72; // @[src/main/scala/ifu/Icache.scala 508:{12,12}]
  wire [31:0] _GEN_75 = 2'h1 == offsetWire ? axiDataVecReg_1 : axiDataVecReg_0; // @[src/main/scala/ifu/Icache.scala 508:{12,12}]
  wire [31:0] _GEN_76 = 2'h2 == offsetWire ? axiDataVecReg_2 : _GEN_75; // @[src/main/scala/ifu/Icache.scala 508:{12,12}]
  wire [31:0] _GEN_77 = 2'h3 == offsetWire ? axiDataVecReg_3 : _GEN_76; // @[src/main/scala/ifu/Icache.scala 508:{12,12}]
  ...
  assign io_checkUnitIO_checkUnit2PreDecoder_bits_inst = _io_checkUnitIO_checkUnit2PreDecoder_valid_T ? _GEN_73 :
    _GEN_77; // @[src/main/scala/ifu/Icache.scala 508:12]
  ...
  assign io_checkUnitIO_checkUnit2Sram_tagBuf = io_checkUnitIO_fetchReq2CheckUnit_bits[31:6]; // @[src/main/scala/ifu/Icache.scala 335:49]
  assign io_checkUnitIO_checkUnit2Sram_replaceIndex = io_checkUnitIO_fetchReq2CheckUnit_bits[5:4]; // @[src/main/scala/ifu/Icache.scala 336:49]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[src/main/scala/ifu/Icache.scala 339:42]
      cacheValidReg_2_0 <= 1'h0; // @[src/main/scala/ifu/Icache.scala 339:42]
    end else if (io_checkUnitIO_wbu2Icache) begin // @[src/main/scala/ifu/Icache.scala 448:41]
      cacheValidReg_2_0 <= 1'h0; // @[src/main/scala/ifu/Icache.scala 451:49]
    end else if (state == 3'h4) begin // @[src/main/scala/ifu/Icache.scala 455:40]
      cacheValidReg_2_0 <= 2'h2 == memIndexWire | cacheValidReg_2_0;
    end
    if (reset) begin // @[src/main/scala/ifu/Icache.scala 339:42]
      cacheValidReg_3_0 <= 1'h0; // @[src/main/scala/ifu/Icache.scala 339:42]
    end else if (io_checkUnitIO_wbu2Icache) begin // @[src/main/scala/ifu/Icache.scala 448:41]
      cacheValidReg_3_0 <= 1'h0; // @[src/main/scala/ifu/Icache.scala 451:49]
    end else if (state == 3'h4) begin // @[src/main/scala/ifu/Icache.scala 455:40]
